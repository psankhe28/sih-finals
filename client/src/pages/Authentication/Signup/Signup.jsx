...
//             }
//             if(validatePhoneNumber(formData.phone) && validateEmail(formData.email)){
//                     alert('An OTP is sent on your mobile number.Please enter it below')
//                 }
...
//                 <div className="panel left-panel">
//                     <div className="content">
//                         <h3>National Student Verification Portal</h3>
//                         <p>
//                             One stop platform to get yourself verified for scholarship and smoothen the process for applying scholarship.
//                         </p>
//                         <Link to='/login'><button className="button transparent" id="sign-up-button" >
//                             Login
//                         </button></Link>
