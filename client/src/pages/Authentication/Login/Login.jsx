...
//     const phoneRegex = /^\+[0-9]{12}$/; // Regex pattern for + followed by 12 digits
...
//                         <h3>New here ?</h3>
//                         <p>
//                             Get yourself registered and verified for eligible inter-state scholarship opportunities.
//                         </p>
//                         <Link to='/signup'><button className="button transparent" id="sign-up-button" >
//                             Sign up
//                         </button></Link>
